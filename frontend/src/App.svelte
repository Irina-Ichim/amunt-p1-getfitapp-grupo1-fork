  ...
  <Router>
    <header>
      ...
      <nav>
        <ul>
          <li>
            <Link style="text-decoration: none;" to="/quienes-somos"
              ><span style="color: #254e5f;">Quiénes Somos</span>
            </Link>
          </li>
          <li>
            <Link style="text-decoration: none;" to="/que-hacemos"
              ><span style="color: #254e5f;">Qué Hacemos</span></Link
            >
          </li>
          <li class="submenu-padre">
            <Link style="text-decoration: none;" to="/servicios"
              ><span style="color: #254e5f;">Servicios</span></Link
            >
          </li>
          <li>
            <Link style="text-decoration: none;" to="/registrar"
              ><span style="color: #254e5f;">Registrar</span></Link
            >
          </li>
        </ul>
      </nav>
    ...
    <footer>
      <section class="footer-registrate">
        <div class="left-section">
          ...
          <p>
            Regístrate para enterarte de las clases nuevas y los servicios
            adicionales antes que nadie.<br />
            Respetamos tu privacidad y nunca compartiremos información con proveedores
            externos.
          </p>
        </div>
